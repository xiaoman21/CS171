...
import A, { isValidElement as gt, Children as lr, PureComponent as Dt, forwardRef as Vp, useRef as Vi, useImperativeHandle as Cm, useState as Ut, useCallback as km, useEffect as Za, useMemo as Xp, cloneElement as Se, createElement as Yp, useContext as Bt, createContext as br, Component as Zp } from "react";
 ...
 */
var Nm = A, Im = Symbol.for("react.element"), Dm = Symbol.for("react.fragment"), Bm = Object.prototype.hasOwnProperty, Lm = Nm.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner, Rm = { key: !0, ref: !0, __self: !0, __source: !0 };
function Qp(e, t, r) {
...
var kg = Cg, Ng = Function.prototype, Ig = Ng.toString;
function Dg(e) {
  if (e != null) {
    try {
      return Ig.call(e);
...
var nd = Dg, Bg = qs, Lg = kg, Rg = Vt, Fg = nd, zg = /[\\^$.*+?()[\]{}|]/g, Wg = /^\[object .+?Constructor\]$/, Ug = Function.prototype, Kg = Object.prototype, qg = Ug.toString, Hg = Kg.hasOwnProperty, Gg = RegExp(
...
var eo = Cb, kb = eo, Nb = Array.prototype, Ib = Nb.splice;
function Db(e) {
...
var M0 = E0, C0 = M0, k0 = /[^.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]|(?=(?:\.|\[\])(?:\.|\[\]|$))/g, N0 = /\\(\\)?/g, I0 = C0(function(e) {
  var t = [];
...
var ud = U0, K0 = qe, q0 = Ks, H0 = D0, G0 = ud;
function V0(e, t) {
...
var pl = function(t) {
  ...
  return Object.keys(i).forEach(function(o) {
    var u;
    Ix((u = i) === null || u === void 0 ? void 0 : u[o], o, r, n) && (a[o] = i[o]);
  }), a;
}, bu = function e(t, r) {
  if (t === r)
    return !0;
  ...
  return tc(t).forEach(function(a, o) {
    if (kx(a))
      ...
      var u = Tt(a.type), s = r[u] || {}, c = s.handler, f = s.once;
      if (c && (!f || !i[u])) {
        var l = c(a, u, o);
        n.push(l), i[u] = !0;
      }
...
function wu(e) {
  var t = e.children, r = e.width, n = e.height, i = e.viewBox, a = e.className, o = e.style, u = e.title, s = e.desc, c = Rx(e, Lx), f = i || {
    width: r,
    height: n,
    x: 0,
    y: 0
...
class Dw {
  constructor(t) {
    ...
    this._x1 = this._y1 = null, this._ = "", this._append = t == null ? wd : Iw(t);
  }
  moveTo(t, r) {
  ...
  arcTo(t, r, n, i, a) {
    ...
    if (this._x1 === null)
      ...
      Math.abs(_ - 1) > nr && this._append`L${t + _ * f},${r + _ * l}`, this._append`A${a},${a},0,0,${+(l * p > f * v)},${this._x1 = t + m * s},${this._y1 = r + m * c}`;
    }
  }
  arc(t, r, n, i, a, o) {
    if (t = +t, r = +r, n = +n, o = !!o, n < 0) throw new Error(`negative radius: ${n}`);
    let u = n * Math.cos(i), s = n * Math.sin(i), c = t + u, f = r + s, l = 1 ^ o, h = o ? i - a : a - i;
    this._x1 === null ? this._append`M${c},${f}` : (Math.abs(this._x1 - c) > nr || Math.abs(this._y1 - f) > nr) && this._append`L${c},${f}`, n && (h < 0 && (h = h % Pu + Pu), h > Nw ? this._append`A${n},${n},0,1,${l},${t - u},${r - s}A${n},${n},0,1,${l},${this._x1 = c},${this._y1 = f}` : h > nr && this._append`A${n},${n},0,${+(h >= Au)},${l},${this._x1 = t + n * Math.cos(a)},${this._y1 = r + n * Math.sin(a)}`);
  }
  rect(t, r, n, i) {
...
function Ni(e, t, r) {
  ...
  function c(l) {
    var h, p, v, d = (l = nc(l)).length, y, g = !1, w, x = new Array(d), _ = new Array(d);
    for (a == null && (u = o(w = s())), h = 0; h <= d; ++h) {
      ...
      g && (x[h] = +e(y, h, l), _[h] = +t(y, h, l), u.point(n ? +n(y, h, l) : x[h], r ? +r(y, h, l) : _[h]));
    }
...
function c_() {
  var e = ue([]), t = ju, r = Dr, n = u_;
  function i(a) {
    var o = Array.from(e.apply(this, arguments), s_), u, s = o.length, c = -1, f;
    for (const l of a)
      for (u = 0, ++c; u < s; ++u)
        (o[u][c] = [0, +n(l, o[u].key, c, a)]).data = l;
    for (u = 0, f = nc(t(o)); u < s; ++u)
      o[f[u]].index = u;
    return r(o, f), o;
  }
...
var H_ = q_, G_ = to, V_ = N_, X_ = D_, Y_ = L_, Z_ = F_, J_ = H_;
function pn(e) {
...
var oc = xO, Ol = _i, Sl = mO, wO = Hs, _O = Ud, OO = bO, SO = oc, AO = 1, PO = 2, $O = "[object Boolean]", jO = "[object Date]", TO = "[object Error]", EO = "[object Map]", MO = "[object Number]", CO = "[object RegExp]", kO = "[object Set]", NO = "[object String]", IO = "[object Symbol]", DO = "[object ArrayBuffer]", BO = "[object DataView]", Al = Ol ? Ol.prototype : void 0, Vo = Al ? Al.valueOf : void 0;
...
var cc = g1, b1 = Lt, x1 = cc, w1 = Rt, _1 = "[object Arguments]", O1 = "[object Array]", S1 = "[object Boolean]", A1 = "[object Date]", P1 = "[object Error]", $1 = "[object Function]", j1 = "[object Map]", T1 = "[object Number]", E1 = "[object Object]", M1 = "[object RegExp]", C1 = "[object Set]", k1 = "[object String]", N1 = "[object WeakMap]", I1 = "[object ArrayBuffer]", D1 = "[object DataView]", B1 = "[object Float32Array]", L1 = "[object Float64Array]", R1 = "[object Int8Array]", F1 = "[object Int16Array]", z1 = "[object Int32Array]", W1 = "[object Uint8Array]", U1 = "[object Uint8ClampedArray]", K1 = "[object Uint16Array]", q1 = "[object Uint32Array]", fe = {};
fe[B1] = fe[L1] = fe[R1] = fe[F1] = fe[z1] = fe[W1] = fe[U1] = fe[K1] = fe[q1] = !0;
fe[_1] = fe[O1] = fe[I1] = fe[S1] = fe[D1] = fe[A1] = fe[P1] = fe[$1] = fe[j1] = fe[T1] = fe[E1] = fe[M1] = fe[C1] = fe[k1] = fe[N1] = !1;
function H1(e) {
...
var kS = CS, El = kS, NS = 1, IS = Object.prototype, DS = IS.hasOwnProperty;
function BS(e, t, r, n, i, a) {
  var o = r & NS, u = El(e), s = u.length, c = El(t), f = c.length;
  if (s != f && !o)
    return !1;
  for (var l = s; l--; ) {
    var h = u[l];
    if (!(o ? h in t : DS.call(t, h)))
      return !1;
  }
...
var LS = BS, RS = xr, FS = Ot, zS = RS(FS, "DataView"), WS = zS, US = xr, KS = Ot, qS = US(KS, "Promise"), HS = qS, GS = xr, VS = Ot, XS = GS(VS, "Set"), Yd = XS, YS = xr, ZS = Ot, JS = YS(ZS, "WeakMap"), QS = JS, Cu = WS, ku = Gs, Nu = HS, Iu = Yd, Du = QS, Zd = Lt, dn = nd, Ml = "[object Map]", eA = "[object Object]", Cl = "[object Promise]", kl = "[object Set]", Nl = "[object WeakMap]", Il = "[object DataView]", tA = dn(Cu), rA = dn(ku), nA = dn(Nu), iA = dn(Iu), aA = dn(Du), ir = Zd;
(Cu && ir(new Cu(new ArrayBuffer(1))) != Il || ku && ir(new ku()) != Ml || Nu && ir(Nu.resolve()) != Cl || Iu && ir(new Iu()) != kl || Du && ir(new Du()) != Nl) && (ir = function(e) {
...
var oA = ir, Xo = Rd, uA = Ud, sA = RO, cA = LS, Dl = oA, Bl = qe, Ll = Hd, lA = Vd, fA = 1, Rl = "[object Arguments]", Fl = "[object Array]", Ii = "[object Object]", hA = Object.prototype, zl = hA.hasOwnProperty;
function pA(e, t, r, n, i, a) {
  var o = Bl(e), u = Bl(t), s = o ? Fl : Dl(e), c = u ? Fl : Dl(t);
  s = s == Rl ? Ii : s, c = c == Rl ? Ii : c;
  var f = s == Ii, l = c == Ii, h = s == c;
  if (h && Ll(e)) {
    if (!Ll(t))
      return !1;
    o = !0, f = !1;
...
var IA = NA, DA = sd, BA = uc, LA = qe, RA = sc, FA = cc, zA = no;
function WA(e, t, r) {
  t = DA(t, e);
...
var RP = LP, Yo = Yd, FP = RP, zP = oc, WP = 1 / 0, UP = Yo && 1 / zP(new Yo([, -0]))[1] == WP ? function(e) {
  return new Yo(e);
} : FP, KP = UP, qP = Fd, HP = IP, GP = BP, VP = Wd, XP = KP, YP = oc, ZP = 200;
function JP(e, t, r) {
...
var C$ = M$, k$ = uv, N$ = C$, I$ = N$(k$), fc = I$, D$ = fc, B$ = Si;
function L$(e, t) {
  var r = -1, n = B$(e) ? Array(e.length) : [];
  return D$(e, function(i, a, o) {
    n[++r] = t(i, a, o);
  }), n;
}
var sv = L$;
...
var _o = kj, Nj = ov, Ij = tj, Dj = jj, Jl = _o, Bj = Dj(function(e, t) {
  if (e == null)
    return [];
  var r = t.length;
  return r > 1 && Jl(e, t[0], t[1]) ? t = [] : r > 2 && Jl(t[0], t[1], t[2]) && (t = [t[0]]), Ij(e, Nj(t, 1), []);
}), Lj = Bj;
...
var Vj = function(t) {
  var r = t.separator, n = r === void 0 ? " : " : r, i = t.contentStyle, a = i === void 0 ? {} : i, o = t.itemStyle, u = o === void 0 ? {} : o, s = t.labelStyle, c = s === void 0 ? {} : s, f = t.payload, l = t.formatter, h = t.itemSorter, p = t.wrapperClassName, v = t.labelClassName, d = t.label, y = t.labelFormatter, g = t.accessibilityLayer, w = g === void 0 ? !1 : g, x = function() {
    if (f && f.length) {
      var T = {
        padding: 0,
        margin: 0
        ...
        var I = Jo({
          ...
          paddingBottom: 4,
          color: k.color || "#000"
        }, u), D = k.formatter || l || Gj, R = k.value, F = k.name, q = R, G = F;
        if (D && q != null && G != null) {
          var W = D(R, F, k, C, f);
          if (Array.isArray(W)) {
            var V = Rj(W, 2);
...
function Jj(e) {
  ...
  return ee(On, Di(Di(Di(Di({}, "".concat(On, "-right"), L(r) && t && L(t.x) && r >= t.x), "".concat(On, "-left"), L(r) && t && L(t.x) && r < t.x), "".concat(On, "-bottom"), L(n) && t && L(t.y) && n >= t.y), "".concat(On, "-top"), L(n) && t && L(t.y) && n < t.y));
}
function tf(e) {
  ...
  var v = l + u, d = s[n] + c;
  return v > d ? Math.max(f, s[n]) : Math.max(l, s[n]);
}
function Qj(e) {
...
var af = 1, cT = /* @__PURE__ */ function(e) {
  ...
  return uT(t, e), nT(t, [{
    ...
    key: "render",
    value: function() {
      var n = this, i = this.props, a = i.active, o = i.allowEscapeViewBox, u = i.animationDuration, s = i.animationEasing, c = i.children, f = i.coordinate, l = i.hasPayload, h = i.isAnimationActive, p = i.offset, v = i.position, d = i.reverseDirection, y = i.useTranslate3d, g = i.viewBox, w = i.wrapperStyle, x = eT({
...
var ge = /* @__PURE__ */ function(e) {
  ...
  return mT(t, e), pT(t, [{
    key: "render",
    value: function() {
      var n = this, i = this.props, a = i.active, o = i.allowEscapeViewBox, u = i.animationDuration, s = i.animationEasing, c = i.content, f = i.coordinate, l = i.filterNull, h = i.isAnimationActive, p = i.offset, v = i.payload, d = i.payloadUniqBy, y = i.position, g = i.reverseDirection, w = i.useTranslate3d, x = i.viewBox, _ = i.wrapperStyle, m = v ?? [];
...
var ET = TT, MT = ET, sf = Vt, CT = un, cf = NaN, kT = /^[-+]0x[0-9a-f]+$/i, NT = /^0b[01]+$/i, IT = /^0o[0-7]+$/i, DT = parseInt;
function BT(e) {
  if (typeof e == "number")
    return e;
  if (CT(e))
  ...
  e = MT(e);
  var r = NT.test(e);
  return r || IT.test(e) ? DT(e.slice(2), r ? 2 : 8) : kT.test(e) ? cf : +e;
}
...
function WT(e, t, r) {
  ...
  function v(b) {
    return c = b, u = setTimeout(g, t), f ? p(b) : o;
  }
  function d(b) {
    var O = b - s, P = b - c, $ = t - O;
    return l ? zT($, a - P) : $;
...
var dt = /* @__PURE__ */ Vp(function(e, t) {
  var r = e.aspect, n = e.initialDimension, i = n === void 0 ? {
    width: -1,
    height: -1
  } : n, a = e.width, o = a === void 0 ? "100%" : a, u = e.height, s = u === void 0 ? "100%" : u, c = e.minWidth, f = c === void 0 ? 0 : c, l = e.minHeight, h = e.maxHeight, p = e.children, v = e.debounce, d = v === void 0 ? 0 : v, y = e.id, g = e.className, w = e.onResize, x = e.style, _ = x === void 0 ? {} : x, m = Vi(null), b = Vi();
  ...
  var T = Xp(function() {
    ...
    r && r > 0 && (C ? I = C / r : I && (C = I * r), h && I > h && (I = h)), Et(C > 0 || I > 0, `The width(%s) and height(%s) of chart should be greater than 0,
       please check the style of container, or the props width(%s) and height(%s),
       or add a minWidth(%s) or minHeight(%s) or use aspect(%s) to control the
       height and width.`, C, I, o, s, f, l, r);
    var D = !Array.isArray(p) && Tt(p.type).endsWith("Chart");
...
function mv(e) {
  ...
  for (var t = e; t.includes("*") || t.includes("/"); ) {
    var r, n = (r = mf.exec(t)) !== null && r !== void 0 ? r : [], i = ca(n, 4), a = i[1], o = i[2], u = i[3], s = Li.parse(a ?? ""), c = Li.parse(u ?? ""), f = o === "*" ? s.multiply(c) : s.divide(c);
    if (f.isNaN())
      return Er;
    t = t.replace(mf, f.toString());
  }
  for (; t.includes("+") || /.-\d+(?:\.\d+)?/.test(t); ) {
    var l, h = (l = gf.exec(t)) !== null && l !== void 0 ? l : [], p = ca(h, 4), v = p[1], d = p[2], y = p[3], g = Li.parse(v ?? ""), w = Li.parse(y ?? ""), x = d === "+" ? g.add(w) : g.subtract(w);
    if (x.isNaN())
      return Er;
...
var gv = /[ \f\n\r\t\v\u2028\u2029]+/, bv = function(t) {
  ...
  for (var d = "…", y = function(C) {
    var I = l.slice(0, C), D = bv({
      ...
      style: s,
      children: I + d
    }).wordsWithComputedWidth, R = h(D), F = R.length > o || v(R).width > Number(i);
    return [F, R];
  }, g = 0, w = l.length - 1, x = 0, _; g <= w && x <= l.length - 1; ) {
  ...
  var r = t.x, n = r === void 0 ? 0 : r, i = t.y, a = i === void 0 ? 0 : i, o = t.lineHeight, u = o === void 0 ? "1em" : o, s = t.capHeight, c = s === void 0 ? "0.71em" : s, f = t.scaleToFit, l = f === void 0 ? !1 : f, h = t.textAnchor, p = h === void 0 ? "start" : h, v = t.verticalAnchor, d = v === void 0 ? "end" : v, y = t.fill, g = y === void 0 ? Sf : y, w = xf(t, AE), x = Xp(function() {
    return kE({
      breakAll: w.breakAll,
      children: w.children,
      maxLines: w.maxLines,
  ...
  }, [w.breakAll, w.children, w.maxLines, l, w.style, w.width]), _ = w.dx, m = w.dy, b = w.angle, O = w.className, P = w.breakAll, $ = xf(w, PE);
  if (!Ae(n) || !Ae(a))
    return null;
...
function dc(e) {
  let t, r, n;
  e.length !== 2 ? (t = Gt, r = (u, s) => Gt(e(u), s), n = (u, s) => e(u) - s) : (t = e === Gt || e === NE ? e : IE, r = e, n = e);
...
function _v(e, t, r = 0, n = 1 / 0, i) {
  ...
  for (i = i === void 0 ? wv : zE(i); n > r; ) {
    if (n - r > 600) {
      const s = n - r + 1, c = t - r + 1, f = Math.log(s), l = 0.5 * Math.exp(2 * f / 3), h = 0.5 * Math.sqrt(f * l * (s - l) / s) * (c - s / 2 < 0 ? -1 : 1), p = Math.max(r, Math.floor(t - c * l / s + h)), v = Math.min(n, Math.floor(t + (s - c) * l / s + h));
      _v(e, t, p, v, i);
    }
    const a = e[t];
    let o = r, u = n;
...
function qE(e, t, r) {
  if (e = Float64Array.from(DE(e)), !(!(n = e.length) || isNaN(t = +t))) {
...
function Vn() {
  var e = vc().unknown(void 0), t = e.domain, r = e.range, n = 0, i = 1, a, o, u = !1, s = 0, c = 0, f = 0.5;
  delete e.unknown;
  function l() {
    var h = t().length, p = i < n, v = p ? i : n, d = p ? n : i;
    a = (d - v) / Math.max(1, h - s + c * 2), u && (a = Math.floor(a)), v += (d - v - a * (h - s)) * f, o = a * (1 - s), u && (v = Math.round(v), o = Math.round(o));
...
yc(ht, aM, Sv($i, {
  ...
  clamp() {
    return new ht(Df(this.h), Fi(this.s), Fi(this.l), pa(this.opacity));
  },
  displayable() {
  ...
  formatHsl() {
    const e = pa(this.opacity);
    return `${e === 1 ? "hsl(" : "hsla("}${Df(this.h)}, ${Fi(this.s) * 100}%, ${Fi(this.l) * 100}%${e === 1 ? ")" : `, ${e})`}`;
  }
}));
function Df(e) {
...
function Oo() {
  ...
  function f() {
    ...
    return o !== Fe && (o = bM(e[0], e[h - 1])), u = h > 2 ? wM : xM, s = c = null, l;
  }
  function l(h) {
...
function jM(e) {
  ...
  function c(l) {
    l = Jn(l);
    var h = l.fill, p = l.align, v = l.sign, d = l.symbol, y = l.zero, g = l.width, w = l.comma, x = l.precision, _ = l.trim, m = l.type;
    ...
    function M(j) {
      ...
      if (m === "c")
        ...
        j = +j;
        var D = j < 0 || 1 / j < 0;
        if (j = isNaN(j) ? s : P(Math.abs(j), x), _ && (j = PM(j)), D && +j == 0 && v !== "+" && (D = !1), T = (D ? v === "(" ? v : u : v === "-" || v === "(" ? "" : v) + T, N = (m === "s" ? Uf[8 + $v / 3] : "") + N + (D && v === "(" ? ")" : ""), $) {
...
function _c(e) {
  ...
  let n = 10, i, a;
  function o() {
    return i = BM(n), a = DM(n), r()[0] < 0 ? (i = Hf(i), a = Hf(a), e(kM, NM)) : e(Kf, qf), t;
  }
...
function Rv(e, t, r, n, i, a) {
  ...
  function u(c, f, l) {
    const h = f < c;
    h && ([c, f] = [f, c]);
    const p = l && typeof l.range == "function" ? l : s(c, f, l), v = p ? p.range(c, +f + 1) : [];
    return h ? v.reverse() : v;
  }
  function s(c, f, l) {
    const h = Math.abs(f - c) / l, p = dc(([, , y]) => y).right(o, h);
    if (p === o.length) return e.every(Hu(c / au, f / au, l));
    if (p === 0) return ga.every(Math.max(Hu(c, f, l), 1));
    const [v, d] = o[h / o[p - 1][2] < o[p][2] / h ? p - 1 : p];
    return v.every(d);
  }
  return [u, s];
}
const [YM, ZM] = Rv(It, Cc, Po, Lv, Ec, jc), [JM, QM] = Rv(Nt, Mc, Ao, Ti, Tc, $c);
function ou(e) {
  if (0 <= e.y && e.y < 100) {
...
function eC(e) {
  var t = e.dateTime, r = e.date, n = e.time, i = e.periods, a = e.days, o = e.shortDays, u = e.months, s = e.shortMonths, c = Pn(i), f = $n(i), l = Pn(a), h = $n(a), p = Pn(o), v = $n(o), d = Pn(u), y = $n(u), g = Pn(s), w = $n(s), x = {
    a: D,
    A: R,
    b: F,
    B: q,
...
function HC(e, t) {
  return e = Uv(e), re(Ur.count(It(e), e) + (It(e).getUTCDay() === 4), t, 2);
}
function GC(e) {
  return e.getUTCDay();
}
...
function kc(e, t, r, n, i, a, o, u, s, c) {
  var f = bc(), l = f.invert, h = f.domain, p = c(".%L"), v = c(":%S"), d = c("%I:%M"), y = c("%I %p"), g = c("%a %d"), w = c("%b %d"), x = c("%B"), _ = c("%Y");
  function m(b) {
  ...
  return f.invert = function(b) {
    ...
    var O = h();
    return (!b || typeof b.range != "function") && (b = t(O[0], O[O.length - 1], b ?? 10)), b ? h(Mv(O, b)) : f;
  }, f.copy = function() {
    return ji(f, kc(e, t, r, n, i, a, o, u, s, c));
  }, f;
}
function nk() {
...
function ik() {
  return st.apply(kc(YM, ZM, It, Cc, Po, So, Ec, jc, sr, qv).domain([Date.UTC(2e3, 0, 1), Date.UTC(2e3, 0, 2)]), arguments);
}
function $o() {
...
function jo() {
  ...
  function p(d) {
    return isNaN(d = +d) ? h : (d = 0.5 + ((d = +f(d)) - a) * (n * d < n * a ? u : s), c(l ? Math.max(0, Math.min(1, d)) : d));
  }
  p.domain = function(d) {
    return arguments.length ? ([e, t, r] = d, i = f(e = +e), a = f(t = +t), o = f(r = +r), u = i === a ? 0 : 0.5 / (a - i), s = a === o ? 0 : 0.5 / (o - a), n = a < i ? -1 : 1, p) : [e, t, r];
  }, p.clamp = function(d) {
  ...
  return p.range = v(yn), p.rangeRound = v(gc), p.unknown = function(d) {
    ...
    return f = d, i = d(e), a = d(t), o = d(r), u = i === a ? 0 : 0.5 / (a - i), s = a === o ? 0 : 0.5 / (o - a), n = a < i ? -1 : 1, p;
  };
}
function Yv() {
  var e = Yt(jo()(Fe));
...
function Ic() {
  var e = Sc(jo());
  return e.copy = function() {
    return Zt(e, Ic()).exponent(e.exponent());
  }, Ft.apply(e, arguments);
}
function ok() {
...
}, Bc, pe = !0, ot = "[DecimalError] ", hr = ot + "Invalid argument: ", Dc = ot + "Exponent out of range: ", gn = Math.floor, ar = Math.pow, Lk = /^(\d+(\.\d*)?|\.\d+)(e[+-]?\d+)?$/i, Ye, $e = 1e7, he = 7, ey = 9007199254740991, wa = gn(ey / he), U = {};
...
U.times = U.mul = function(e) {
  var t, r, n, i, a, o, u, s, c, f = this, l = f.constructor, h = f.d, p = (e = new l(e)).d;
  if (!f.s || !e.s) return new l(0);
  for (e.s *= f.s, r = f.e + e.e, s = h.length, c = p.length, s < c && (a = h, h = p, p = a, o = s, s = c, c = o), a = [], o = s + c, n = o; n--; ) a.push(0);
  for (n = c; --n >= 0; ) {
    for (t = 0, i = s + n; i > n; )
...
var Mt = /* @__PURE__ */ function() {
  ...
  return function(n, i, a, o) {
    var u, s, c, f, l, h, p, v, d, y, g, w, x, _, m, b, O, P, $ = n.constructor, M = n.s == i.s ? 1 : -1, j = n.d, T = i.d;
    if (!n.s) return new $(n);
    ...
    if (w = w / he + 2 | 0, c = 0, O == 1)
      ...
      do
        f = 0, u = t(T, d, O, y), u < 0 ? (g = d[0], O != y && (g = g * $e + (d[1] || 0)), f = g / b | 0, f > 1 ? (f >= $e && (f = $e - 1), l = e(T, f), h = l.length, y = d.length, u = t(l, d, h, y), u == 1 && (f--, r(l, O < h ? P : T, h))) : (f == 0 && (u = f = 1), l = T.slice()), h = l.length, h < y && l.unshift(0), r(d, l, y), u == -1 && (y = d.length, u = t(T, d, O, y), u < 1 && (f++, r(d, O < y ? P : T, y))), y = d.length) : u === 0 && (f++, d = [0]), v[c++] = f, u && d[0] ? d[y++] = j[_] || 0 : (d = [j[_]], y = 1);
...
function ry(e, t) {
  ...
  if (be(e) > 16) throw Error(Dc + be(e));
...
function Qn(e, t) {
  var r, n, i, a, o, u, s, c, f, l = 1, h = 10, p = e, v = p.d, d = p.constructor, y = d.precision;
  ...
  for (u = o = p = Mt(p.minus(Ye), p.plus(Ye), c), f = oe(p.times(p), c), i = 3; ; ) {
    if (o = oe(o.times(f), c), s = u.plus(Mt(o, new d(i), c)), yt(s.d).slice(0, c) === yt(u.d).slice(0, c))
      return u = u.times(2), a !== 0 && (u = u.plus(su(d, c + 2, y).times(a + ""))), u = Mt(u, new d(l), c), d.precision = y, t == null ? (pe = !0, oe(u, y)) : u;
    u = s, i += 2;
  }
}
function ch(e, t) {
  ...
  if (t = t.slice(n, i), t) {
    if (i -= n, r = r - n - 1, e.e = gn(r / he), e.d = [], n = (r + 1) % he, r < 0 && (n += he), n < i) {
      ...
      n -= i;
    for (; n--; ) t += "0";
    if (e.d.push(+t), pe && (e.e > wa || e.e < -wa)) throw Error(Dc + r);
  } else
    e.s = 0, e.e = 0, e.d = [0];
  return e;
}
...
function ny(e, t) {
  var r, n, i, a, o, u, s, c, f, l, h = e.constructor, p = h.precision;
  if (!e.s || !t.s)
    return t.s ? t.s = -t.s : t = new h(e), pe ? oe(t, p) : t;
  if (s = e.d, l = t.d, n = t.e, c = e.e, s = s.slice(), o = c - n, o) {
    for (f = o < 0, f ? (r = s, o = -o, u = l.length) : (r = l, n = c, u = s.length), i = Math.max(Math.ceil(p / he), u) + 2, o > i && (o = i, r.length = 1), r.reverse(), i = o; i--; ) r.push(0);
    r.reverse();
  } else {
...
var qk = function(t) {
  ...
  return t === 1 ? r : fh(function() {
    ...
    return o >= t ? r.apply(void 0, i) : e(t - o, fh(function() {
      ...
      return r.apply(void 0, Fk(f).concat(s));
    }));
  });
}, Mo = function(t) {
...
function uN(e) {
  ...
  if (c === -1 / 0 || f === 1 / 0) {
    var l = f === 1 / 0 ? [c].concat(es(Ju(0, i - 1).map(function() {
      return 1 / 0;
...
function sN(e, t) {
  ...
  if (s === c)
    return [s];
  var f = Math.max(t, 2), l = ly(new ae(c).sub(s).div(f - 1), a, 0), h = [].concat(es(Co.rangeStep(new ae(s), new ae(c).sub(new ae(0.99).mul(l)), l)), [c]);
  return n > i ? Qu(h) : h;
}
...
var bn = /* @__PURE__ */ function(e) {
  ...
  return PN(t, e), _N(t, [{
    key: "render",
    value: function() {
      var n = this.props, i = n.offset, a = n.layout, o = n.width, u = n.dataKey, s = n.data, c = n.dataPointFormatter, f = n.xAxis, l = n.yAxis, h = gN(n, hN), p = Q(h, !1);
      ...
      var v = s.map(function(d) {
        ...
        if (Array.isArray(_)) {
          ...
          b = O = _;
        if (a === "vertical") {
          var $ = f.scale, M = w + i, j = M + o, T = M - o, N = $(x - b), k = $(x + O);
          m.push({
            x1: k,
            y1: j,
            x2: k,
          ...
          var C = l.scale, I = g + i, D = I - o, R = I + o, F = C(x - b), q = C(x + O);
          m.push({
            x1: D,
            y1: q,
            x2: R,
...
var BN = function(t) {
  ...
  if (a && a.axisType === "angleAxis" && Math.abs(Math.abs(a.range[1] - a.range[0]) - 360) <= 1e-6)
    for (var s = a.range, c = 0; c < u; c++) {
      var f = c > 0 ? i[c - 1].coordinate : i[u - 1].coordinate, l = i[c].coordinate, h = c >= u - 1 ? i[0].coordinate : i[c + 1].coordinate, p = void 0;
      if (pt(l - f) !== pt(h - l)) {
        var v = [];
  ...
  if (c) {
    ...
    if ((d === "vertical" || d === "horizontal" && v === "middle") && p !== "center" && L(t[p]))
      return ve(ve({}, t), {}, Ir({}, p, t[p] + (l || 0)));
    if ((d === "horizontal" || d === "vertical" && p === "center") && v !== "middle" && L(t[v]))
      return ve(ve({}, t), {}, Ir({}, v, t[v] + (h || 0)));
  }
  return t;
}, zN = function(t, r, n) {
  ...
  if (u && u.length) {
    ...
    return t.reduce(function(c, f) {
      var l = ke(f, n);
      if (X(l)) return c;
      var h = Array.isArray(l) ? [Eo(l), To(l)] : [l, l], p = s.reduce(function(v, d) {
...
var Pa = Math.PI / 180, aI = function(t) {
  ...
  var n = t.x, i = t.y, a = r.cx, o = r.cy, u = oI({
    x: n,
    y: i
  }, {
    x: a,
  ...
  if (o === 0)
    return !0;
  var f = sI(r), l = f.startAngle, h = f.endAngle, p = u, v;
  if (l <= h) {
    for (; p > h; )
      p -= 360;
    for (; p < l; )
...
var wI = function(t) {
  ...
  var i = t.position, a = t.viewBox, o = t.offset, u = t.className, s = a, c = s.cx, f = s.cy, l = s.innerRadius, h = s.outerRadius, p = s.startAngle, v = s.endAngle, d = s.clockWise, y = (l + h) / 2, g = _I(p, v), w = g >= 0 ? 1 : -1, x, _;
  i === "insideStart" ? (x = p + w * o, _ = d) : i === "insideEnd" ? (x = v - w * o, _ = !d) : i === "end" && (x = v + w * o, _ = d), _ = g <= 0 ? _ : !_;
  var m = Ce(c, f, y, x), b = Ce(c, f, y, x + (_ ? 1 : -1) * 359), O = "M".concat(m.x, ",").concat(m.y, `
  ...
  var r = t.viewBox, n = t.parentViewBox, i = t.offset, a = t.position, o = r, u = o.x, s = o.y, c = o.width, f = o.height, l = f >= 0 ? 1 : -1, h = l * i, p = l > 0 ? "end" : "start", v = l > 0 ? "start" : "end", d = c >= 0 ? 1 : -1, y = d * i, g = d > 0 ? "end" : "start", w = d > 0 ? "start" : "end";
  if (a === "top") {
    var x = {
      x: u + c / 2,
      y: s - l * i,
...
function Ie(e) {
  var t = e.offset, r = t === void 0 ? 5 : t, n = yI(e, lI), i = Oe({
    offset: r
...
var _y = function(t) {
  var r = t.cx, n = t.cy, i = t.angle, a = t.startAngle, o = t.endAngle, u = t.r, s = t.radius, c = t.innerRadius, f = t.outerRadius, l = t.x, h = t.y, p = t.top, v = t.left, d = t.width, y = t.height, g = t.clockWise, w = t.labelViewBox;
  if (w)
    return w;
  if (L(d) && L(y)) {
    if (L(l) && L(h))
  ...
  return t ? t === !0 ? /* @__PURE__ */ A.createElement(Ie, {
    key: "label-implicit",
    viewBox: r
  }) : Ae(t) ? /* @__PURE__ */ A.createElement(Ie, {
    key: "label-implicit",
    viewBox: r,
    value: t
    ...
    content: t,
    viewBox: r
  }) : Z(t) ? /* @__PURE__ */ A.createElement(Ie, {
    key: "label-implicit",
    content: t,
    viewBox: r
  }) : sn(t) ? /* @__PURE__ */ A.createElement(Ie, ai({
    viewBox: r
  }, t, {
    key: "label-implicit"
  })) : null : null;
...
Ie.parseViewBox = _y;
Ie.renderCallByParent = jI;
function TI(e) {
  var t = e == null ? 0 : e.length;
  return t ? e[t - 1] : void 0;
}
var EI = TI;
const MI = /* @__PURE__ */ ce(EI);
function oi(e) {
  "@babel/helpers - typeof";
...
var CI = ["valueAccessor"], kI = ["data", "dataKey", "clockWise", "id", "textBreakAll"];
function NI(e) {
  return LI(e) || BI(e) || DI(e) || II();
}
function II() {
  throw new TypeError(`Invalid attempt to spread non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
...
var UI = function(t) {
  return Array.isArray(t.value) ? MI(t.value) : t.value;
};
function Ct(e) {
  var t = e.valueAccessor, r = t === void 0 ? UI : t, n = $h(e, CI), i = n.data, a = n.dataKey, o = n.clockWise, u = n.id, s = n.textBreakAll, c = $h(n, kI);
  return !i || !i.length ? null : /* @__PURE__ */ A.createElement(se, {
    className: "recharts-label-list"
  }, i.map(function(f, l) {
    var h = X(a) ? r(f, l) : ke(f && f.payload, a), p = X(u) ? {} : {
      id: "".concat(u, "-").concat(l)
    };
    return /* @__PURE__ */ A.createElement(Ie, $a({}, Q(f, !0), c, p, {
...
function qI(e, t) {
  ...
  if (!r)
    return i;
  var a = KI(e.label, t);
  return [a].concat(NI(i));
}
Ct.renderCallByParent = qI;
function ui(e) {
  "@babel/helpers - typeof";
...
var XI = function(t, r) {
  ...
  var r = t.cx, n = t.cy, i = t.radius, a = t.angle, o = t.sign, u = t.isExternal, s = t.cornerRadius, c = t.cornerIsExternal, f = s * (u ? 1 : -1) + i, l = Math.asin(s / f) / Pa, h = c ? a : a + o * l, p = Ce(r, n, f, h), v = Ce(r, n, i, h), d = c ? a - o * l : a, y = Ce(r, n, f * Math.cos(l * Pa), d);
  return {
    center: p,
    circleTangency: v,
    lineTangency: y,
  ...
  var r = t.cx, n = t.cy, i = t.innerRadius, a = t.outerRadius, o = t.startAngle, u = t.endAngle, s = XI(o, u), c = o + s, f = Ce(r, n, a, o), l = Ce(r, n, a, c), h = "M ".concat(f.x, ",").concat(f.y, `
  ...
  var r = t.cx, n = t.cy, i = t.innerRadius, a = t.outerRadius, o = t.cornerRadius, u = t.forceCornerRadius, s = t.cornerIsExternal, c = t.startAngle, f = t.endAngle, l = pt(f - c), h = Ui({
    cx: r,
    cy: n,
    radius: a,
    angle: c,
    ...
    cornerRadius: o,
    cornerIsExternal: s
  }), g = y.circleTangency, w = y.lineTangency, x = y.theta, _ = s ? Math.abs(c - f) : Math.abs(c - f) - d - x;
  if (_ < 0)
  ...
  var r = Th(Th({}, ZI), t), n = r.cx, i = r.cy, a = r.innerRadius, o = r.outerRadius, u = r.cornerRadius, s = r.forceCornerRadius, c = r.cornerIsExternal, f = r.startAngle, l = r.endAngle, h = r.className;
  if (o < a || f === l)
    return null;
  var p = ee("recharts-sector", h), v = o - a, d = vr(u, v, 0, !0), y;
  return d > 0 && Math.abs(f - l) < 360 ? y = YI({
    cx: n,
    cy: i,
    innerRadius: a,
    outerRadius: o,
...
var Ch = {
  ...
  var r = t.type, n = r === void 0 ? "linear" : r, i = t.points, a = i === void 0 ? [] : i, o = t.baseLine, u = t.layout, s = t.connectNulls, c = s === void 0 ? !1 : s, f = t2(n, u), l = c ? a.filter(function(d) {
    return Ki(d);
  }) : a, h;
  if (Array.isArray(o)) {
  ...
  return u === "vertical" && L(o) ? h = Ni().y(Tn).x1(jn).x0(o) : L(o) ? h = Ni().x(jn).y1(Tn).y0(o) : h = Ad().x(jn).y(Tn), h.defined(Ki).curve(f), h(l);
}, ja = function(t) {
  var r = t.className, n = t.points, i = t.path, a = t.pathRef;
  if ((!n || !n.length) && !i)
    return null;
  var o = n && n.length ? r2(t) : i;
  return /* @__PURE__ */ it.createElement("path", ss({}, Q(t, !1), Yi(t), {
    className: ee("recharts-curve", r),
    d: o,
    ref: a
  }));
}, Ay = { exports: {} }, n2 = "SECRET_DO_NOT_PASS_THIS_OR_YOU_WILL_BE_FIRED", i2 = n2, a2 = i2;
function Py() {
}
function $y() {
}
...
Ay.exports = o2();
var u2 = Ay.exports;
const ne = /* @__PURE__ */ ce(u2);
var s2 = Object.getOwnPropertyNames, c2 = Object.getOwnPropertySymbols, l2 = Object.prototype.hasOwnProperty;
function kh(e, t) {
...
var p2 = "__v", d2 = "__o", v2 = "_owner", Ih = Object.getOwnPropertyDescriptor, Dh = Object.keys;
function y2(e, t, r) {
  var n = e.length;
  if (t.length !== n)
    return !1;
...
function jy(e, t, r, n) {
  return (n === v2 || n === d2 || n === p2) && (e.$$typeof || t.$$typeof) ? !0 : h2(t, n) && r.equals(e[n], t[n], n, n, e, t, r);
}
var P2 = "[object Arguments]", $2 = "[object Boolean]", j2 = "[object Date]", T2 = "[object Error]", E2 = "[object Map]", M2 = "[object Number]", C2 = "[object Object]", k2 = "[object RegExp]", N2 = "[object Set]", I2 = "[object String]", D2 = "[object URL]", B2 = Array.isArray, Rh = typeof ArrayBuffer < "u" && typeof ArrayBuffer.isView == "function" ? ArrayBuffer.isView : null, Fh = Object.assign, L2 = Object.prototype.toString.call.bind(Object.prototype.toString);
function R2(e) {
  var t = e.areArraysEqual, r = e.areDatesEqual, n = e.areErrorsEqual, i = e.areFunctionsEqual, a = e.areMapsEqual, o = e.areNumbersEqual, u = e.areObjectsEqual, s = e.arePrimitiveWrappersEqual, c = e.areRegExpsEqual, f = e.areSetsEqual, l = e.areTypedArraysEqual, h = e.areUrlsEqual, p = e.unknownTagComparators;
...
function F2(e) {
  var t = e.circular, r = e.createCustomConfig, n = e.strict, i = {
    areArraysEqual: n ? En : y2,
    areDatesEqual: m2,
    areErrorsEqual: g2,
    areFunctionsEqual: b2,
    areMapsEqual: n ? kh(Bh, En) : Bh,
    areNumbersEqual: x2,
    areObjectsEqual: n ? En : w2,
    arePrimitiveWrappersEqual: _2,
    areRegExpsEqual: O2,
    areSetsEqual: n ? kh(Lh, En) : Lh,
    areTypedArraysEqual: n ? En : S2,
    areUrlsEqual: A2,
...
function Jt(e) {
  e === void 0 && (e = {});
  var t = e.circular, r = t === void 0 ? !1 : t, n = e.createInternalComparator, i = e.createState, a = e.strict, o = a === void 0 ? !1 : a, u = F2(e), s = R2(u), c = n ? n(s) : z2(s);
  return W2({ circular: r, comparator: s, createState: i, equals: c, strict: o });
}
function K2(e) {
  ...
  var e = {}, t = function() {
    ...
    if (!r) {
      if (Array.isArray(a)) {
        if (!a.length)
          return;
        var o = a, u = q2(o), s = u[0], c = u.slice(1);
        if (typeof s == "number") {
          zh(i.bind(null, c), s);
          return;
        }
...
var Q2 = function(t, r) {
  ...
  return t.map(function(i) {
    return "".concat(tD(i), " ").concat(r, "ms ").concat(n);
  }).join(",");
};
function rD(e, t) {
  return aD(e) || iD(e, t) || Ey(e, t) || nD();
}
function nD() {
  throw new TypeError(`Invalid attempt to destructure non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
...
var Ta = 1e-4, My = function(t, r) {
  ...
  return function(n) {
    var i = My(t, r), a = [].concat(oD(i.map(function(o, u) {
      return o * u;
    }).slice(1)), [0]);
    return Cy(a, n);
  };
  ...
  var l = Hh(i, o), h = Hh(a, u), p = lD(i, o), v = function(g) {
  ...
  var t = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {}, r = t.stiff, n = r === void 0 ? 100 : r, i = t.damping, a = i === void 0 ? 8 : i, o = t.dt, u = o === void 0 ? 17 : o, s = function(f, l, h) {
    var p = -(f - l) * n, v = h * a, d = h + (p - v) * u / 1e3, y = h * u / 1e3 + f;
...
var Ea = function(t, r, n) {
  ...
  var i = Dn(function(a, o) {
    if (ps(o)) {
      var u = t(o.from, o.to, o.velocity), s = gD(u, 2), c = s[0], f = s[1];
      return Me(Me({}, o), {}, {
        from: c,
        velocity: f
      });
...
const OD = function(e, t, r, n, i) {
  var a = Q2(e, t), o = a.reduce(function(y, g) {
    ...
    c || (c = g);
    var w = g - c, x = w / r.dt;
    u = _D(r, u, x), i(Me(Me(Me({}, e), t), h())), c = g, p() || (s = requestAnimationFrame(l));
  }, d = function(g) {
    f || (f = g);
    var w = (g - f) / n, x = Dn(function(m, b) {
      return Ea.apply(void 0, Vh(b).concat([r(w)]));
    }, o);
    if (i(Me(Me(Me({}, e), t), x)), w < 1)
      s = requestAnimationFrame(l);
    else {
      var _ = Dn(function(m, b) {
...
var SD = ["children", "begin", "duration", "attributeName", "easing", "isActive", "steps", "from", "to", "canBegin", "onAnimationEnd", "shouldReAnimate", "onAnimationReStart"];
function AD(e, t) {
  if (e == null) return {};
  var r = PD(e, t), n, i;
  if (Object.getOwnPropertySymbols) {
...
var _t = /* @__PURE__ */ function(e) {
  ...
  function r(n, i) {
    var a;
    MD(this, r), a = t.call(this, n, i);
    var o = a.props, u = o.isActive, s = o.attributeName, c = o.from, f = o.to, l = o.steps, h = o.children, p = o.duration;
  ...
  return kD(r, [{
    ...
    value: function(i) {
      ...
      if (u) {
        ...
        if (!(U2(i.to, f) && i.canBegin && i.isActive)) {
    ...
    key: "runJSAnimation",
    value: function(i) {
      var a = this, o = i.from, u = i.to, s = i.duration, c = i.easing, f = i.begin, l = i.onAnimationEnd, h = i.onAnimationStart, p = OD(o, u, hD(c), s, this.changeStyle), v = function() {
        a.stopJSAnimation = p();
      };
      this.manager.start([h, f, v, s, l]);
    }
  }, {
    key: "runStepAnimation",
    value: function(i) {
      var a = this, o = i.steps, u = i.begin, s = i.onAnimationStart, c = o[0], f = c.style, l = c.duration, h = l === void 0 ? 0 : l, p = function(d, y, g) {
        if (g === 0)
          return d;
        ...
        return [].concat(lu(d), [j, w, O]).filter(eD);
      };
      return this.manager.start([s].concat(lu(o.reduce(p, [f, Math.max(h, u)])), [i.onAnimationEnd]));
    }
  }, {
    key: "runAnimation",
    value: function(i) {
      this.manager || (this.manager = Y2());
      var a = i.begin, o = i.duration, u = i.attributeName, s = i.to, c = i.easing, f = i.onAnimationStart, l = i.onAnimationEnd, h = i.steps, p = i.children, v = this.manager;
    ...
    value: function() {
      ...
      var s = AD(i, SD), c = lr.count(a), f = this.state.style;
...
var ep = function(t, r, n, i, a) {
  ...
  var r = Qh(Qh({}, GD), t), n = Vi(), i = Ut(-1), a = LD(i, 2), o = a[0], u = a[1];
  Za(function() {
  ...
  var s = r.x, c = r.y, f = r.width, l = r.height, h = r.radius, p = r.className, v = r.animationEasing, d = r.animationDuration, y = r.animationBegin, g = r.isAnimationActive, w = r.isUpdateAnimationActive;
...
var tB = function(t, r, n, i, a, o) {
  ...
  var r = t.x, n = r === void 0 ? 0 : r, i = t.y, a = i === void 0 ? 0 : i, o = t.top, u = o === void 0 ? 0 : o, s = t.left, c = s === void 0 ? 0 : s, f = t.width, l = f === void 0 ? 0 : f, h = t.height, p = h === void 0 ? 0 : h, v = t.className, d = QD(t, VD), y = XD({
    x: n,
    y: a,
    top: u,
    left: c,
  ...
  return !L(n) || !L(a) || !L(l) || !L(p) || !L(u) || !L(c) ? null : /* @__PURE__ */ A.createElement("path", bs({}, Q(y, !0), {
    className: ee("recharts-cross", v),
    d: tB(n, a, l, p, u, c)
  }));
}, nB = Xd, iB = nB(Object.getPrototypeOf, Object), aB = iB, oB = Lt, uB = aB, sB = Rt, cB = "[object Object]", lB = Function.prototype, fB = Object.prototype, Iy = lB.toString, hB = fB.hasOwnProperty, pB = Iy.call(Object);
function dB(e) {
  if (!sB(e) || oB(e) != cB)
    return !1;
  var t = uB(e);
  ...
  return typeof r == "function" && r instanceof r && Iy.call(r) == pB;
}
var vB = dB;
...
var ap = function(t, r, n, i, a) {
  ...
  var s = r.x, c = r.y, f = r.upperWidth, l = r.lowerWidth, h = r.height, p = r.className, v = r.animationEasing, d = r.animationDuration, y = r.animationBegin, g = r.isUpdateAnimationActive;
...
function VB(e) {
  var t = e.activeTooltipItem, r = e.graphicalItem, n = e.itemData, i = HB(r, t), a = GB(r, t), o = n.filter(function(s, c) {
    var f = Ei(a, s), l = r.props[i].filter(function(v) {
      var d = qB(r, t);
      return d(v, t);
...
var xL = function(t) {
  ...
  if (!r || !r.length)
    return {};
  var s = r.length, c = Nn().domain(Ia(0, s)).range([a, a + o - u]), f = c.domain().map(function(l) {
    return c(l);
  });
  return {
    isTextActive: !1,
  ...
  return gL(t, e), dL(t, [{
    ...
    key: "getIndex",
    value: function(n) {
      var i = n.startX, a = n.endX, o = this.state.scaleValues, u = this.props, s = u.gap, c = u.data, f = c.length - 1, l = Math.min(i, a), h = Math.max(i, a), p = t.getIndexInRange(o, l), v = t.getIndexInRange(o, h);
      return {
        startIndex: p - p % s,
    ...
    key: "handleSlideDrag",
    value: function(n) {
      var i = this.state, a = i.slideMoveStartX, o = i.startX, u = i.endX, s = this.props, c = s.x, f = s.width, l = s.travellerWidth, h = s.startIndex, p = s.endIndex, v = s.onChange, d = n.pageX - a;
      d > 0 ? d = Math.min(d, c + f - l - u, c + f - l - o) : d < 0 && (d = Math.max(d, c - o, c - u));
      var y = this.getIndex({
        startX: o + d,
        endX: u + d
      });
    ...
    value: function(n) {
      var i = this.state, a = i.brushMoveStartX, o = i.movingTravellerId, u = i.endX, s = i.startX, c = this.state[o], f = this.props, l = f.x, h = f.width, p = f.travellerWidth, v = f.onChange, d = f.gap, y = f.data, g = {
    ...
    value: function(n, i) {
      var a, o, u = this, s = this.props, c = s.y, f = s.travellerWidth, l = s.height, h = s.traveller, p = s.ariaLabel, v = s.data, d = s.startIndex, y = s.endIndex, g = Math.max(n, this.props.x), w = hu(hu({}, Q(this.props, !1)), {}, {
        x: g,
        y: c,
        width: f,
        height: l
    ...
    key: "renderText",
    value: function() {
      var n = this.props, i = n.startIndex, a = n.endIndex, o = n.y, u = n.height, s = n.travellerWidth, c = n.stroke, f = this.state, l = f.startX, h = f.endX, p = 5, v = {
        pointerEvents: "none",
        fill: c
      };
      return /* @__PURE__ */ A.createElement(se, {
        className: "recharts-brush-texts"
      }, /* @__PURE__ */ A.createElement(la, Da({
        textAnchor: "end",
        verticalAnchor: "middle",
        x: Math.min(l, h) - p,
        y: o + u / 2
      }, v), this.getTextOfTick(i)), /* @__PURE__ */ A.createElement(la, Da({
        textAnchor: "start",
        verticalAnchor: "middle",
        x: Math.max(l, h) + s + p,
        y: o + u / 2
    ...
    key: "render",
    value: function() {
      var n = this.props, i = n.data, a = n.className, o = n.children, u = n.x, s = n.y, c = n.width, f = n.height, l = n.alwaysShowText, h = this.state, p = h.startX, v = h.endX, d = h.isTextActive, y = h.isSlideMoving, g = h.isTravellerMoving, w = h.isTravellerFocused;
...
var kL = CL, NL = kL, IL = uv, DL = Xt;
function BL(e, t) {
  var r = {};
  return t = DL(t), IL(e, function(n, i, a) {
    NL(r, i, t(n, i, a));
  }), r;
}
var LL = BL;
...
function iR(e, t) {
  var r = e.x, n = e.y, i = rR(e, JL), a = "".concat(r), o = parseInt(a, 10), u = "".concat(n), s = parseInt(u, 10), c = "".concat(t.height || i.height), f = parseInt(c, 10), l = "".concat(t.width || i.width), h = parseInt(l, 10);
  ...
  return dR(t, e), lR(t, [{
    ...
    value: function(n) {
      ...
      return n && n.map(function(l, h) {
        var p = h === s, v = p ? c : o, d = me(me(me({}, f), l), {}, {
          isActive: p,
          option: v,
          index: h,
          dataKey: u,
    ...
    value: function(n, i) {
      ...
      return /* @__PURE__ */ A.createElement(se, v, l.map(function(d) {
    ...
    key: "render",
    value: function() {
      var n = this.props, i = n.hide, a = n.data, o = n.className, u = n.xAxis, s = n.yAxis, c = n.left, f = n.top, l = n.width, h = n.height, p = n.isAnimationActive, v = n.background, d = n.id;
      if (i || !a || !a.length)
        return null;
...
qt(Te, "getComposedData", function(e) {
  var t = e.props, r = e.item, n = e.barPosition, i = e.bandSize, a = e.xAxis, o = e.yAxis, u = e.xAxisTicks, s = e.yAxisTicks, c = e.stackedData, f = e.dataStartIndex, l = e.displayedData, h = e.offset, p = qN(n, r);
  if (!p)
    return null;
  var v = t.layout, d = r.type.defaultProps, y = d !== void 0 ? me(me({}, d), r.props) : r.props, g = y.dataKey, w = y.children, x = y.minPointSize, _ = v === "horizontal" ? o : a, m = c ? _.scale.domain() : null, b = QN({
    ...
    var j, T, N, k, C, I;
    c ? j = HN(c[f + M], m) : (j = ke($, g), Array.isArray(j) || (j = [b, j]));
    var D = aR(x, zy.defaultProps.minPointSize)(j[1], M);
    if (v === "horizontal") {
  ...
  return f.reduce(function(p, v) {
    ...
    if (d.type === "number" && (d.padding === "gap" || d.padding === "no-gap")) {
      ...
      if (k.forEach(function(le, ye) {
        ...
        var C = N / T, I = d.layout === "vertical" ? n.height : n.width;
        if (d.padding === "gap" && (O = C * I / 2), d.padding === "no-gap") {
    ...
    i === "xAxis" ? (j = y === "top" && !_ || y === "bottom" && _, $ = n.left, M = l[b] - j * d.height) : i === "yAxis" && (j = y === "left" && !_ || y === "right" && _, $ = l[b] - j * d.width, M = n.top);
    var V = lt(lt(lt({}, d), W), {}, {
      realScaleType: G,
      x: $,
      y: M,
    ...
    return V.bandSize = Aa(V, W), !d.hide && i === "xAxis" ? l[b] += (j ? -1 : 1) * V.height : d.hide || (l[b] += (j ? -1 : 1) * V.width), lt(lt({}, p), {}, Io({}, v, V));
  }, {});
}, qy = function(t, r) {
  var n = t.x, i = t.y, a = r.x, o = r.y;
  return {
...
var Wc = function(t) {
  var r = Object.keys(t).reduce(function(n, i) {
    return lt(lt({}, n), {}, Io({}, i, Hy.create(t[i])));
  }, {});
  return lt(lt({}, r), {}, {
    apply: function(i) {
...
var IR = NR, DR = PR, BR = IR, LR = DR(BR), RR = LR;
...
var zR = $0(function(e) {
  ...
  var r = t.state, n = r.xAxisMap, i = r.yAxisMap, a = r.offset, o = t.clipPathId, u = t.children, s = t.width, c = t.height, f = zR(a);
...
function s3(e) {
  var t = e.x, r = e.y, n = e.segment, i = e.xAxisId, a = e.yAxisId, o = e.shape, u = e.className, s = e.alwaysShow, c = WR(), f = Jy(i), l = Qy(a), h = qR();
  if (!c || !h)
    return null;
  ...
  var p = Wc({
    x: f.scale,
    y: l.scale
  }), v = Ae(t), d = Ae(r), y = n && n.length === 2, g = u3(p, v, d, y, h, e.position, f.orientation, l.orientation, e);
  if (!g)
    return null;
  ...
  }, o3(o, M), Ie.renderCallByParent(e, bR({
    x1: _,
    y1: m,
    x2: O,
    y2: P
...
var m3 = function(t) {
  ...
  return v3(t, e), f3(t, [{
    ...
    value: function() {
      ...
      if (Et(u === void 0, 'The alwaysShow prop is deprecated. Please use ifOverflow="extendDomain" instead.'), !c || !f)
        return null;
      var l = m3(this.props);
      if (!l)
        return null;
      var h = l.x, p = l.y, v = this.props, d = v.shape, y = v.className, g = xt(this.props, "hidden") ? "url(#".concat(s, ")") : void 0, w = Pp(Pp({
        clipPath: g
      }, Q(this.props, !0)), {}, {
        cx: h,
        cy: p
      ...
      }, t.renderDot(d, w), Ie.renderCallByParent(this.props, {
        x: h - o,
        y: p - o,
        width: 2 * o,
        height: 2 * o
...
Do(Bo, "displayName", "ReferenceDot");
Do(Bo, "defaultProps", {
  isFront: !1,
  ifOverflow: "discard",
  xAxisId: 0,
...
var P3 = function(t, r, n, i, a) {
  ...
  return S3(t, e), x3(t, [{
    ...
    value: function() {
      ...
      var l = Ae(i), h = Ae(a), p = Ae(o), v = Ae(u), d = this.props.shape;
      if (!l && !h && !p && !v && !d)
        return null;
      ...
      return /* @__PURE__ */ A.createElement(se, {
        ...
        clipPath: g
      }, Q(this.props, !0)), y)), Ie.renderCallByParent(this.props, y));
    }
  }]);
}(A.Component);
...
function E3(e, t, r, n, i) {
  for (var a = (n || []).slice(), o = t.start, u = t.end, s = 0, c = 1, f = o, l = function() {
    ...
    }, w = v.coordinate, x = s === 0 || Ua(e, w, g, f, u);
    x || (s = 0, f = o, c += 1), x && (f = w + e * (g() / 2 + i), s += c);
  }, h; c <= a.length; )
    if (h = l(), h) return h.v;
  return [];
}
...
function I3(e, t, r, n, i, a) {
  ...
  if (a) {
    ...
    p && (c = f.tickCoord - e * (l / 2 + i), o[u - 1] = Ne(Ne({}, f), {}, {
      isShow: !0
    }));
  }
...
function Xc(e, t, r) {
  ...
  var h = [], p = u === "top" || u === "bottom" ? "width" : "height", v = f && p === "width" ? kn(f, {
    fontSize: t,
    letterSpacing: r
  }) : {
    width: 0,
  ...
  return s === "equidistantPreserveStart" ? E3(y, g, d, i, o) : (s === "preserveStart" || s === "preserveStartEnd" ? h = I3(y, g, d, i, o, s === "preserveStartEnd") : h = N3(y, g, d, i, o), h.filter(function(w) {
    return w.isShow;
  }));
}
var D3 = ["viewBox"], B3 = ["viewBox"], L3 = ["ticks"];
function Jr(e) {
  "@babel/helpers - typeof";
...
var xn = /* @__PURE__ */ function(e) {
  ...
  return q3(t, e), z3(t, [{
    ...
    value: function(n, i) {
      var a = n.viewBox, o = pu(n, D3), u = this.props, s = u.viewBox, c = pu(u, B3);
    ...
    value: function(n) {
      var i = this.props, a = i.x, o = i.y, u = i.width, s = i.height, c = i.orientation, f = i.tickSize, l = i.mirror, h = i.tickMargin, p, v, d, y, g, w, x = l ? -1 : 1, _ = n.tickSize || f, m = L(n.tickCoord) ? n.tickCoord : n.coordinate;
      switch (c) {
        case "top":
          p = v = n.coordinate, y = o + +!l * s, d = y - x * _, w = d - x * h, g = m;
          break;
        case "left":
          d = y = n.coordinate, v = a + +!l * u, p = v - x * _, g = p - x * h, w = m;
          break;
        case "right":
          d = y = n.coordinate, v = a + +l * u, p = v + x * _, g = p + x * h, w = m;
          break;
    ...
    value: (
       ...
       */
      function(n, i, a) {
        var o = this, u = this.props, s = u.tickLine, c = u.stroke, f = u.tick, l = u.tickFormatter, h = u.unit, p = Xc(_e(_e({}, this.props), {}, {
          ticks: n
    ...
    value: function() {
      ...
      if (f)
        return null;
      var l = this.props, h = l.ticks, p = pu(l, L3), v = h;
      ...
      }, a && this.renderAxisLine(), this.renderTicks(v, this.state.fontSize, this.state.letterSpacing), Ie.renderCallByParent(this.props));
    }
  }], [{
    key: "renderTickItem",
...
var iF = function(t, r) {
  ...
  return by(Xc(De(De(De({}, xn.defaultProps), n), {}, {
    ticks: jt(n, !0),
    viewBox: {
      x: 0,
      y: 0,
...
function nt(e) {
  var t, r, n, i, a, o, u = qc(), s = Hc(), c = HR(), f = De(De({}, e), {}, {
  ...
  }), l = f.x, h = f.y, p = f.width, v = f.height, d = f.syncWithTicks, y = f.horizontalValues, g = f.verticalValues, w = UR(), x = KR();
  if (!L(p) || p <= 0 || !L(v) || v <= 0 || !L(l) || l !== +l || !L(h) || h !== +h)
    return null;
  var _ = f.verticalCoordinatesGenerator || iF, m = f.horizontalCoordinatesGenerator || aF, b = f.horizontalPoints, O = f.verticalPoints;
  if ((!b || !b.length) && Z(m)) {
    var P = y && y.length, $ = m({
      yAxis: x ? De(De({}, x), {}, {
        ticks: P ? y : x.ticks
...
var At = /* @__PURE__ */ function(e) {
  function t() {
    ...
    return r = vF(this, t, [].concat(i)), ft(r, "state", {
      ...
      for (var f = Math.floor(o / c), l = o % c, h = u - o, p = [], v = 0, d = 0; v < s.length; d += s[v], ++v)
        if (d + s[v] > l) {
          p = [].concat(Tr(s.slice(0, v)), [l - d]);
          break;
        }
      var y = p.length % 2 === 0 ? [0, h] : [h];
      return [].concat(Tr(t.repeat(s, f)), Tr(p), y).map(function(g) {
        return "".concat(g, "px");
      }).join(", ");
  ...
  return gF(t, e), dF(t, [{
    ...
    value: function(n, i) {
      ...
      return /* @__PURE__ */ A.createElement(se, p, l.map(function(v) {
    ...
    value: function(n, i, a) {
      ...
      if (o && !this.state.isAnimationFinished)
        return null;
      var u = this.props, s = u.dot, c = u.points, f = u.dataKey, l = Q(this.props, !1), h = Q(s, !0), p = c.map(function(d, y) {
        var g = Ge(Ge(Ge({
          key: "dot-".concat(y),
          r: 3
        }, l), h), {}, {
    ...
    value: function(n, i, a, o) {
      ...
      u.ref;
      var l = Np(u, oF), h = Ge(Ge(Ge({}, Q(l, !0)), {}, {
        fill: "none",
    ...
    value: function(n, i) {
      var a = this, o = this.props, u = o.points, s = o.strokeDasharray, c = o.isAnimationActive, f = o.animationBegin, l = o.animationDuration, h = o.animationEasing, p = o.animationId, v = o.animateNewValues, d = o.width, y = o.height, g = this.state, w = g.prevPoints, x = g.totalLength;
      return /* @__PURE__ */ A.createElement(_t, {
        begin: f,
        duration: l,
        isActive: c,
        ...
        if (w) {
          var b = w.length / u.length, O = u.map(function(T, N) {
            ...
            if (w[k]) {
              var C = w[k], I = Re(C.x, T.x), D = Re(C.y, T.y);
              return Ge(Ge({}, T), {}, {
                x: I(m),
                y: D(m)
              });
    ...
    key: "render",
    value: function() {
      var n, i = this.props, a = i.hide, o = i.dot, u = i.points, s = i.className, c = i.xAxis, f = i.yAxis, l = i.top, h = i.left, p = i.width, v = i.height, d = i.isAnimationActive, y = i.id;
      if (a || !u || !u.length)
        return null;
      var g = this.state.isAnimationFinished, w = u.length === 1, x = ee("recharts-line", s), _ = c && c.allowDataOverflow, m = f && f.allowDataOverflow, b = _ || m, O = X(y) ? this.id : y, P = (n = Q(o, !1)) !== null && n !== void 0 ? n : {
        r: 3,
        strokeWidth: 2
      }, $ = P.r, M = $ === void 0 ? 3 : $, j = P.strokeWidth, T = j === void 0 ? 2 : j, N = Nx(o) ? o : {}, k = N.clipDot, C = k === void 0 ? !0 : k, I = M * 2 + T;
      return /* @__PURE__ */ A.createElement(se, {
        className: x
...
ft(At, "getComposedData", function(e) {
  var t = e.props, r = e.xAxis, n = e.yAxis, i = e.xAxisTicks, a = e.yAxisTicks, o = e.dataKey, u = e.bandSize, s = e.displayedData, c = e.offset, f = t.layout, l = s.map(function(h, p) {
    var v = ke(h, o);
    return f === "horizontal" ? {
      x: Sa({
        axis: r,
...
function NF(e, t, r) {
  return t = Ga(t), IF(e, vm() ? Reflect.construct(t, r || [], Ga(e).constructor) : t.apply(e, r));
}
function IF(e, t) {
...
var wn = /* @__PURE__ */ function(e) {
  ...
  return BF(t, e), kF(t, [{
    ...
    key: "render",
    value: function() {
      var n = this.props, i = n.hide, a = n.points, o = n.line, u = n.className, s = n.xAxis, c = n.yAxis, f = n.left, l = n.top, h = n.width, p = n.height, v = n.id, d = n.isAnimationActive;
      if (i || !a || !a.length)
        return null;
...
Ht(wn, "getComposedData", function(e) {
  var t = e.xAxis, r = e.yAxis, n = e.zAxis, i = e.item, a = e.displayedData, o = e.xAxisTicks, u = e.yAxisTicks, s = e.offset, c = i.props.tooltipType, f = Ke(i.props.children, Ai), l = X(t.dataKey) ? i.props.dataKey : t.dataKey, h = X(r.dataKey) ? i.props.dataKey : r.dataKey, p = n && n.dataKey, v = n ? n.range : Fo.defaultProps.range, d = v && v[0], y = t.scale.bandwidth ? t.scale.bandwidth() : 0, g = r.scale.bandwidth ? r.scale.bandwidth() : 0, w = a.map(function(x, _) {
    var m = ke(x, l), b = ke(x, h), O = !X(p) && ke(x, p) || "-", P = [{
...
function GF(e) {
  ...
  return i == null ? null : (
    ...
    /* @__PURE__ */ it.createElement(xn, Ds({}, i, {
...
var Fs = function(t, r, n, i, a) {
  var o = Ke(t, Vc), u = Ke(t, Bo), s = [].concat(Rp(o), Rp(u)), c = Ke(t, Ro), f = "".concat(i, "Id"), l = i[0], h = r;
...
(function(e) {
  ...
  }, u.prototype.emit = function(c, f, l, h, p, v) {
    var d = r ? r + c : c;
...
var pz = /* @__PURE__ */ function() {
  ...
  return fz(e, [{
    key: "setDetails",
    value: function(r) {
      var n, i = r.coordinateList, a = i === void 0 ? null : i, o = r.container, u = o === void 0 ? null : o, s = r.layout, c = s === void 0 ? null : s, f = r.offset, l = f === void 0 ? null : f, h = r.mouseHandlerCallback, p = h === void 0 ? null : h;
...
function yz(e, t, r) {
  ...
  if (e === "horizontal")
    ...
    if (e === "centric") {
      var u = t.cx, s = t.cy, c = t.innerRadius, f = t.outerRadius, l = t.angle, h = Ce(u, s, c, l), p = Ce(u, s, f, l);
...
function xz(e) {
  var t, r, n = e.element, i = e.tooltipEventType, a = e.isActive, o = e.activeCoordinate, u = e.activePayload, s = e.offset, c = e.activeTooltipIndex, f = e.tooltipAxisBandSize, l = e.layout, h = e.chartName, p = (t = n.props.cursor) !== null && t !== void 0 ? t : (r = n.type.defaultProps) === null || r === void 0 ? void 0 : r.cursor;
...
var Us = function(t, r, n, i) {
  ...
  var a = i || {
    x: t.chartX,
    y: t.chartY
  }, o = Fz(a, n), u = t.orderedTooltipTicks, s = t.tooltipAxis, c = t.tooltipTicks, f = BN(o, u, c, s);
  if (f >= 0 && c) {
    var l = c[f] && c[f].value, h = Us(t, r, f, l), p = zz(n, u, f, a);
    return {
  ...
  var n = r.axes, i = r.graphicalItems, a = r.axisType, o = r.axisIdKey, u = r.stackGroups, s = r.dataStartIndex, c = r.dataEndIndex, f = t.layout, l = t.children, h = t.stackOffset, p = gy(f, a);
  return n.reduce(function(v, d) {
    ...
    dz(g.domain, _, w) && (T = is(g.domain, null, _), p && (w === "number" || b !== "auto") && (k = In(M, x, "category")));
    var C = Em(w);
    if (!T || T.length === 0) {
      var I, D = (I = g.domain) !== null && I !== void 0 ? I : C;
      if (x) {
        if (T = In(M, x, w), w === "category" && p) {
          var R = Ox(T);
          m && R ? (N = T, T = Ia(0, j)) : m || (T = xh(D, T, d).reduce(function(W, V) {
            return W.indexOf(V) >= 0 ? W : [].concat(on(W), [V]);
          }, []));
        } else if (w === "category")
          m ? T = T.filter(function(W) {
            return W !== "" && !X(W);
          }) : T = xh(D, T, d).reduce(function(W, V) {
        ...
        p && (w === "number" || b !== "auto") && (k = In(M, x, "category"));
      } else p ? T = Ia(0, j) : u && u[$] && u[$].hasStack && w === "number" ? T = h === "expand" ? [0, 1] : xy(u[$].stackGroups, s, c) : T = my(M, i.filter(function(W) {
        var V = o in W.props ? W.props[o] : W.type.defaultProps[o], le = "hide" in W.props ? W.props.hide : W.type.defaultProps.hide;
        return V === $ && (P || !le);
      }), w, f, !0);
      if (w === "number")
        T = Fs(l, T, $, a, O), D && (T = is(D, T, _));
  ...
  var n = r.graphicalItems, i = r.Axis, a = r.axisType, o = r.axisIdKey, u = r.stackGroups, s = r.dataStartIndex, c = r.dataEndIndex, f = t.layout, l = t.children, h = zo(t.data, {
    graphicalItems: n,
    dataStartIndex: s,
    dataEndIndex: c
  ...
  return n.reduce(function(y, g) {
    ...
    if (!y[x]) {
      d++;
      var m;
      return v ? m = Ia(0, p) : u && u[x] && u[x].hasStack ? (m = xy(u[x].stackGroups, s, c), m = Fs(l, m, x, a)) : (m = is(_, my(h, n.filter(function(b) {
        ...
        return $ === x && !M;
      }), "number", f), i.defaultProps.allowDataOverflow), m = Fs(l, m, x, a)), E(E({}, y), {}, H({}, x, E(E({
        axisType: a
      }, i.defaultProps), {}, {
        hide: !0,
  ...
  var n = r.axisType, i = n === void 0 ? "xAxis" : n, a = r.AxisComp, o = r.graphicalItems, u = r.stackGroups, s = r.dataStartIndex, c = r.dataEndIndex, f = t.children, l = "".concat(i, "Id"), h = Ke(f, a), p = {};
  ...
  var n = t.props, i = t.graphicalItems, a = t.xAxisMap, o = a === void 0 ? {} : a, u = t.yAxisMap, s = u === void 0 ? {} : u, c = n.width, f = n.height, l = n.children, h = n.margin || {}, p = Xe(l, Gr), v = Xe(l, Ze), d = Object.keys(s).reduce(function(m, b) {
  ...
  var x = c - g.left - g.right, _ = f - g.top - g.bottom;
  return E(E({
    brushBottom: w
  }, g), {}, {
  ...
  var r = t.chartName, n = t.GraphicalChild, i = t.defaultTooltipEventType, a = i === void 0 ? "axis" : i, o = t.validateTooltipEventTypes, u = o === void 0 ? ["axis"] : o, s = t.axisComponents, c = t.legendContent, f = t.formatAxisMap, l = t.defaultProps, h = function(g, w) {
    var x = w.graphicalItems, _ = w.stackGroups, m = w.offset, b = w.updateId, O = w.dataStartIndex, P = w.dataEndIndex, $ = g.barSize, M = g.layout, j = g.barGap, T = g.barCategoryGap, N = g.maxBarSize, k = Hp(M), C = k.numericAxisName, I = k.cateAxisName, D = Hz(x), R = [];
    return x.forEach(function(F, q) {
      ...
      }, Qt), z = ze[I], Y = ze["".concat(I, "Ticks")], J = _ && _[ye] && _[ye].hasStack && eI(F, _[ye].stackGroups), B = Tt(F.type).indexOf("Bar") >= 0, de = Aa(z, Y), te = [], xe = D && LN({
        barSize: $,
        stackGroups: _,
        totalSize: Vz(ze, I)
      });
    ...
    if (!pl({
      ...
      return null;
    var O = x.children, P = x.layout, $ = x.stackOffset, M = x.data, j = x.reverseStackOrder, T = Hp(P), N = T.numericAxisName, k = T.cateAxisName, C = Ke(O, n), I = ZN(M, C, "".concat(N, "Id"), "".concat(k, "Id"), $, j), D = s.reduce(function(W, V) {
    ...
    Object.keys(D).forEach(function(W) {
      D[W] = f(x, D[W], R, W.replace("Map", ""), r);
    });
    var F = D["".concat(k, "Map")], q = qz(F), G = h(x, E(E({}, D), {}, {
      dataStartIndex: _,
      dataEndIndex: m,
      updateId: b,
      graphicalItems: C,
    ...
    function g(w) {
      ...
      return $z(this, g), m = Ez(this, g, [w]), H(m, "eventEmitterSymbol", Symbol("rechartsEventEmitter")), H(m, "accessibilityManager", new pz()), H(m, "handleLegendBBoxUpdate", function(b) {
        ...
        var O = Dx(b), P = at(m.props, "".concat(O));
        if (O && Z(P)) {
          var $, M;
        ...
        if (b.dataStartIndex !== void 0 || b.dataEndIndex !== void 0)
          ...
          var N = b.chartX, k = b.chartY, C = b.activeTooltipIndex, I = m.state, D = I.offset, R = I.tooltipTicks;
          if (!D)
            return;
          if (typeof $ == "function")
            C = $(R, b);
        ...
        var O, P = m.state, $ = P.isTooltipActive, M = P.activeCoordinate, j = P.activePayload, T = P.offset, N = P.activeTooltipIndex, k = P.tooltipAxisBandSize, C = m.getTooltipEventType(), I = (O = b.props.active) !== null && O !== void 0 ? O : $, D = m.props.layout, R = b.key || "_recharts-cursor";
        ...
        var O = b.props, P = O.radialLines, $ = O.polarAngles, M = O.polarRadius, j = m.state, T = j.radiusAxisMap, N = j.angleAxisMap, k = Kt(T), C = Kt(N), I = C.cx, D = C.cy, R = C.innerRadius, F = C.outerRadius;
        ...
        if (!M)
          return null;
        var j = m.state, T = j.isTooltipActive, N = j.activeCoordinate, k = j.activePayload, C = j.activeLabel, I = j.offset, D = (b = M.props.active) !== null && b !== void 0 ? b : T;
        ...
        if (!b)
          return null;
        var $ = m, M = $.clipPathId, j = m.state, T = j.xAxisMap, N = j.yAxisMap, k = j.offset, C = b.type.defaultProps || {}, I = b.props, D = I.xAxisId, R = D === void 0 ? C.xAxisId : D, F = I.yAxisId, q = F === void 0 ? C.yAxisId : F;
        return /* @__PURE__ */ Se(b, {
          key: b.key || "".concat(O, "-").concat(P),
          xAxis: T[R],
          yAxis: N[q],
        ...
        var O = b.item, P = b.activePoint, $ = b.basePoint, M = b.childIndex, j = b.isRange, T = [], N = O.props.key, k = O.item.type.defaultProps !== void 0 ? E(E({}, O.item.type.defaultProps), O.item.props) : O.item.props, C = k.activeDot, I = k.dataKey, D = E(E({
          index: M,
          dataKey: I,
          cx: P.x,
          cy: P.y,
        ...
        return T.push(g.renderActiveDot(C, D, "".concat(N, "-activePoint-").concat(M))), $ ? T.push(g.renderActiveDot(C, E(E({}, D), {}, {
          cx: $.x,
          cy: $.y
      ...
      value: function() {
        ...
        if (P) {
          ...
          if (!(typeof $ != "number" || $ < 0 || $ > this.state.tooltipTicks.length - 1)) {
            ...
            this.setState(D), this.renderCursor(P), this.accessibilityManager.setIndex($);
          }
        }
      }
    }, {
          ...
          for (var O = 0, P = m.length; O < P; O++) {
            ...
            if (N === "Bar") {
              ...
              return {
                ...
                payload: vi($, b) ? T.data[I] : $.props.data[I]
              };
            }
          }
        return null;
  ...
  H(v, "displayName", r), H(v, "defaultProps", E({
    ...
    if (!bu(_, g.prevChildren)) {
      var D, R, F, q, G = Xe(_, Gr), W = G && (D = (R = G.props) === null || R === void 0 ? void 0 : R.startIndex) !== null && D !== void 0 ? D : M, V = G && (F = (q = G.props) === null || q === void 0 ? void 0 : q.endIndex) !== null && F !== void 0 ? F : j, le = W !== M || V !== j, ye = !X(x), He = ye && !le ? g.updateId : g.updateId + 1;
      return E(E({
        updateId: He
      }, p(E(E({
        props: y
...
const Xz = ({ data: e, year: t }) => {
  ...
  return /* @__PURE__ */ S.jsxs("div", { className: "overview-charts", children: [
    ...
    /* @__PURE__ */ S.jsxs("div", { className: "chart-container", children: [
      ...
      /* @__PURE__ */ S.jsx(dt, { width: "100%", height: 300, children: /* @__PURE__ */ S.jsxs(pr, { data: c, margin: { top: 20, right: 30, left: 20, bottom: 60 }, children: [
        ...
        /* @__PURE__ */ S.jsx(Le, { stroke: "#A4ADBD", tickFormatter: (v) => je(v) }),
        /* @__PURE__ */ S.jsx(
          ge,
          {
    ...
    /* @__PURE__ */ S.jsxs("div", { className: "chart-grid-2", children: [
      /* @__PURE__ */ S.jsxs("div", { className: "chart-container", children: [
        ...
        /* @__PURE__ */ S.jsx(dt, { width: "100%", height: 300, children: /* @__PURE__ */ S.jsxs(pr, { data: f, margin: { top: 20, right: 30, left: 20, bottom: 60 }, children: [
          /* @__PURE__ */ S.jsx(nt, { strokeDasharray: "3 3", stroke: "#333" }),
          /* @__PURE__ */ S.jsx(
            Be,
            {
      ...
      /* @__PURE__ */ S.jsxs("div", { className: "chart-container", children: [
        ...
        /* @__PURE__ */ S.jsx(dt, { width: "100%", height: 300, children: /* @__PURE__ */ S.jsxs(pr, { data: l, margin: { top: 20, right: 30, left: 20, bottom: 60 }, children: [
          /* @__PURE__ */ S.jsx(nt, { strokeDasharray: "3 3", stroke: "#333" }),
          /* @__PURE__ */ S.jsx(
            Be,
            {
    ...
    /* @__PURE__ */ S.jsxs("div", { className: "chart-container", children: [
      ...
      /* @__PURE__ */ S.jsx(dt, { width: "100%", height: 400, children: /* @__PURE__ */ S.jsxs(Mm, { margin: { top: 20, right: 30, left: 20, bottom: 20 }, children: [
        /* @__PURE__ */ S.jsx(nt, { strokeDasharray: "3 3", stroke: "#333" }),
        /* @__PURE__ */ S.jsx(
          Be,
          {
  ...
  const a = i.reduce((g, w) => g + w.views_total, 0), o = i.reduce((g, w) => g + w.uploads_count, 0), u = i.reduce((g, w) => g + w.uploads_short_count, 0), s = i.reduce((g, w) => g + w.views_shorts, 0), c = mt(a, o), f = mt(u, o), l = mt(s, a), h = mt(
  ...
  if (e.length === 0)
    return /* @__PURE__ */ S.jsx("div", { className: "no-data", children: "No data available. Please select at least one channel." });
  const r = t.map((c) => {
    const f = e.filter((w) => w.channelKey === c), l = f.reduce((w, x) => w + x.uploads_count_Normal, 0), h = f.reduce((w, x) => w + x.uploads_count_Short, 0), p = f.reduce((w, x) => w + x.views_total_Normal, 0), v = f.reduce((w, x) => w + x.views_total_Short, 0), d = mt(p, l), y = mt(v, h), g = mt(y, d);
    return {
      channel: c.replace("@", ""),
      avgViewsNormal: d,
      avgViewsShort: y,
  ...
  return /* @__PURE__ */ S.jsxs("div", { className: "short-vs-long-charts", children: [
    /* @__PURE__ */ S.jsxs("div", { className: "chart-container", children: [
      ...
      /* @__PURE__ */ S.jsx(dt, { width: "100%", height: 350, children: /* @__PURE__ */ S.jsxs(pr, { data: n, margin: { top: 20, right: 30, left: 20, bottom: 60 }, children: [
        /* @__PURE__ */ S.jsx(nt, { strokeDasharray: "3 3", stroke: "#333" }),
        /* @__PURE__ */ S.jsx(Be, { dataKey: "channel", stroke: "#A4ADBD", angle: -45, textAnchor: "end", height: 80 }),
        /* @__PURE__ */ S.jsx(Le, { stroke: "#A4ADBD", tickFormatter: (c) => je(c) }),
        /* @__PURE__ */ S.jsx(
          ge,
          {
            contentStyle: { backgroundColor: "#1a1a2e", border: "1px solid #333" },
    ...
    /* @__PURE__ */ S.jsxs("div", { className: "chart-container", children: [
      ...
      /* @__PURE__ */ S.jsx(dt, { width: "100%", height: 350, children: /* @__PURE__ */ S.jsxs(pr, { data: i, margin: { top: 20, right: 30, left: 20, bottom: 60 }, children: [
        /* @__PURE__ */ S.jsx(nt, { strokeDasharray: "3 3", stroke: "#333" }),
        /* @__PURE__ */ S.jsx(Be, { dataKey: "channel", stroke: "#A4ADBD", angle: -45, textAnchor: "end", height: 80 }),
        /* @__PURE__ */ S.jsx(Le, { stroke: "#A4ADBD", label: { value: "Multiplier (x)", angle: -90, position: "insideLeft" } }),
    ...
    /* @__PURE__ */ S.jsxs("div", { className: "chart-container", children: [
      ...
      /* @__PURE__ */ S.jsx(dt, { width: "100%", height: 450, children: /* @__PURE__ */ S.jsxs(Mm, { margin: { top: 20, right: 30, left: 20, bottom: 20 }, children: [
        /* @__PURE__ */ S.jsx(nt, { strokeDasharray: "3 3", stroke: "#333" }),
        /* @__PURE__ */ S.jsx(
          Be,
          {
    ...
    t.length === 1 && /* @__PURE__ */ S.jsxs("div", { className: "chart-container", children: [
      ...
      /* @__PURE__ */ S.jsx(dt, { width: "100%", height: 300, children: /* @__PURE__ */ S.jsxs(
        pr,
        {
  ...
  const [e, t] = Ut(!0), [r, n] = Ut([]), [i, a] = Ut([]), [o, u] = Ut([]), [s, c] = Ut({
    year: 2024,
    selectedChannels: [],
    viewMode: "overview"
  });
  Za(() => {
    Um().then(({ annual: d, monthly: y, shortVsLong: g }) => {
      n(d), a(y), u(g);
      const w = Array.from(new Set(d.map((x) => x.channelKey)));
      c((x) => ({ ...x, selectedChannels: w })), t(!1);
    });
  }, []);
  const f = (d) => {
    c((y) => ({ ...y, ...d }));
  ...
  const l = Array.from(new Set(r.map((d) => d.channelKey))), h = r.filter(
    (d) => d.year === s.year && s.selectedChannels.includes(d.channelKey)
  ), p = i.filter(
    (d) => d.year === s.year && s.selectedChannels.includes(d.channelKey)
  ), v = o.filter(
    (d) => d.year === s.year && s.selectedChannels.includes(d.channelKey)
  ...
  return /* @__PURE__ */ S.jsx("section", { className: "slide-section media-dashboard-slide", id: "dashboard", children: /* @__PURE__ */ S.jsxs("div", { className: "dashboard-container", children: [
    ...
    /* @__PURE__ */ S.jsxs("div", { className: "dashboard-content", children: [
      ...
      /* @__PURE__ */ S.jsxs("div", { className: "dashboard-charts", children: [
        s.viewMode === "overview" && /* @__PURE__ */ S.jsx(Xz, { data: h, year: s.year }),
        s.viewMode === "channel-drilldown" && /* @__PURE__ */ S.jsx(
          Yz,
          {
            data: p,
            year: s.year,
        ...
        s.viewMode === "short-vs-long" && /* @__PURE__ */ S.jsx(
          Zz,
          {
            data: v,
            year: s.year,
